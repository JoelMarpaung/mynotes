...
void main() {
  group('Mock Authentication', () {
    ...
    test(
      'Should be able to inititize in less than 2 seconds',
      () async {
        await provider.initialize();
        expect(provider.isInitialized, true);
      },
    ...
    test('create user should delegate to login function', () async {
      final badEmailUser =
          provider.createUser(email: 'foo@bar.com', password: '123456');
      expect(
        badEmailUser,
        throwsA(
      ...
      final user =
          await provider.createUser(email: 'someone@bar.com', password: 'bar');
